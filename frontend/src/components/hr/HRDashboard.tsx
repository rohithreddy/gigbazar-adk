...
export const HRDashboard: React.FC<HRDashboardProps> = ({
  ...
  const renderJobsView = () => (
    <div className="container mx-auto px-6 py-8">
      ...
      {/* Recent Interviews Section (only in Jobs view) */}
      {interviews.length > 0 && (
        <div className="mt-12">
  ...
  // Render Interviews View (showing ALL interviews)
  const renderInterviewsView = () => (
    <div className="container mx-auto px-6 py-8">
      <div className="mb-6">
        <h2 className="text-3xl font-bold">All Interviews</h2>
        <p className="text-muted-foreground mt-1">
          View all candidate interviews across all job postings
        </p>
      </div>
        ...
        <Card className="p-12 text-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Share your job links with candidates to start receiving interviews
              </p>
  ...
  const renderAnalyticsView = () => (
    <div className="container mx-auto px-6 py-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          View insights and statistics about your hiring process
        </p>
      </div>
