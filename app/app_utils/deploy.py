...
from vertexai._genai.types import AgentEngine, AgentEngineConfig, AgentServerMode
...
@click.option(
    "--description",
    default="Real-time multimodal agent with ADK and Gemini Live API for low-latency voice and video interaction.",
